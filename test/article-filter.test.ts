...
test('normalizePublishedAt · 中文纪年(2026-07-18 BCH 中文版公告实锤 · 老板拍C · UTC 重建零时区漂移)', () => {
    assert.equal(normalizePublishedAt('2021年8月15日'), '2021-08-15T00:00:00.000Z');
    assert.equal(normalizePublishedAt('2026年1月9日'), '2026-01-09T00:00:00.000Z');   // 月日不补零
    assert.equal(normalizePublishedAt('2023年12月13日'), '2023-12-13T00:00:00.000Z'); // 双位月
    assert.equal(normalizePublishedAt('1889年1月1日'), '');                            // 非合理年份不救
});
